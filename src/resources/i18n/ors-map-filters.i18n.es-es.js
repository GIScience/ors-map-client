export default {
  orsMapFilters: {
    ...
    filters: {
      ...
      profile_params: { label: 'Parámetros del perfil' },
      restrictions: { label: 'Restricciones' },
      axleload: {
        label: 'Carga por eje',
      ...
      round_trip: { label: 'Ruta circular' },
      round_trip_length: {
      ...
      alternative_routes: { label: 'Rutas alternativas' },
      target_count: {
      ...
      weightings: { label: 'Ajustes adicionales' },
      green: {
