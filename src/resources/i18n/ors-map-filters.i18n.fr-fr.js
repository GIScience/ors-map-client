export default {
  orsMapFilters: {
    ...
    filters: {
      ...
      profile_params: { label: 'Paramètres de profil' },
      ...
      round_trip: { label: 'Route circulaire' },
      round_trip_length: {
      ...
      alternative_routes: { label: 'Itinéraires alternatifs' },
      target_count: {
      ...
      weightings: { label: 'Paramètres additionnels' },
      green: {
