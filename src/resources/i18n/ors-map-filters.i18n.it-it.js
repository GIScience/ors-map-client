export default {
  orsMapFilters: {
    ...
    filters: {
      ...
      profile_params: { label: 'Proprietà del profilo' },
      restrictions: { label: 'Restrizioni' },
      axleload: {
      ...
      round_trip: { label: 'Andata e ritorno' },
      round_trip_length: {
      ...
      alternative_routes: { label: 'Percorsi alternativi' },
      target_count: {
      ...
      weightings: { label: 'parametri aggiuntivi' },
      green: {
