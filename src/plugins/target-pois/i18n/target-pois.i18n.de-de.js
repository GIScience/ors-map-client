export default {
  targetPois: {
    ...
    'healthcare:speciality': 'Gesundheitswesen Fachbereich',
    'opening_hours': 'Öffnungszeiten',
    'vaccination': 'Impfung',
    routeToThisPlace: 'Route zu diesem Ort',
    loadingPois: 'Impfzentren im dargestellten Kartenausschnitt werden geladen',
    poisLoaded: 'Impfzentren erfolgreich geladen',
