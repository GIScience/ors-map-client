...
const build = () => {
  ...
  const componentMessages = import.meta.glob('@/pages/**/*.i18n.pt-br.js', { eager: true})
  addComponentKeys(componentMessages, translationsObj)

  const sharedPartsMessages = import.meta.glob('@/fragments/**/*.i18n.pt-br.js', { eager: true})
  addComponentKeys(sharedPartsMessages, translationsObj)

  const resourcesMessages = import.meta.glob('@/resources/**/*.i18n.pt-br.js', { eager: true})
  addComponentKeys(resourcesMessages, translationsObj)

  const pluginsMessages = import.meta.glob('@/plugins/**/*.i18n.pt-br.js', { eager: true})
