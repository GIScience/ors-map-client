...
<!--    >-->
<!--&lt;!&ndash;      <l-control-polyline-measure v-if="showControls && distanceMeasureToolAvailable" :options="polylineMeasureOptions"/>&ndash;&gt;-->
<!--      <l-control-scale position="bottomleft" :imperial="true" :metric="true"></l-control-scale>-->

<!--      &lt;!&ndash; draw tool bar is added programmatically via map-view.js setAvoidPolygonDrawingTool method &ndash;&gt;-->
<!--      &lt;!&ndash; <l-draw-toolbar :options="drawingOptions" position="topright"/> &ndash;&gt;-->
...
<!--        :opacity="layer.opacity"-->
<!--        layer-type="overlay"/>-->
<!--      <v-btn size="small" @click.stop="toggleAccessibleMode" v-if="accessibilityToolAvailable"-->
...
<!--      &lt;!&ndash; highlight extra info polyline &ndash;&gt;-->
...
<!--&lt;!&ndash;      <l-height-graph v-if="isAltitudeModalOpen" @closed="closeAltitudeInfo" lg8 sm11 :data="localMapViewDataRawData" :options="lHeightGraphOptions"/>&ndash;&gt;-->
...
<!--      &lt;!&ndash; the container below might be used to to programmatically add controls/components &ndash;&gt;-->
