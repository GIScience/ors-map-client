...
export default {
  "share": {
    ...
    "clickToCopy": "Cliquez pour copier l'URL",
    "share": "Partager (cliquez pour copier)",
    "shareLink": "Partager le lien",
    "short": "Raccourcir l'url",
    "copyUrlInfo": "Vous pouvez également copier le lien depuis la barre d'adresse de votre navigateur.",
    "urlShortened": "URL courte",
