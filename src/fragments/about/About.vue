  ...
  <div>
    ...
    <div v-if="showDefaultAboutContent">
      ...
      <section>
        ...
        <v-alert outline :value="true" color="info">
          ...
          <div class="textjustify">
            <a class="link" href="https://openrouteservice.org/donations/"
              target="_blank">{{$t('about.supportText')}}</a>
          </div>
        </v-alert>
        <br>
        <v-divider></v-divider>
      ...
      <section>
        ...
        <p>
          {{$t('about.sources')}} <a class='link' href='https://github.com/GIScience/ors-map-client'
            target='_blank'>github</a>.
        </p>
        <p>{{$t('about.feelFreeToReportBugs')}} <a href='https://github.com/GIScience/ors-map-client/issues/new'
            target='_blank'>github</a> {{$t('about.orToFixThem')}}.</p>
      </section>
      <v-divider></v-divider>
      <br>
      <section>
        ...
        <v-divider></v-divider>
        <h4 class="sectionHeader"><a class="link" href="https://openrouteservice.org/terms-of-service"
