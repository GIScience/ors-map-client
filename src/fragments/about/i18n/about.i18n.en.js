...
export default {
  about: {
    ...
    feefFreeToReportBugs: 'Please feel free to report bugs on',
    orToFixThem: 'or fix them by yourself and make a pull request',
    hillshadeLayer: 'Hillshade Layer',
    ...
    MapSurferBackgroundLayer: 'MapSurfer Background Layer',
    openMapSurferTilesWMS: 'OpenMapSurfer Tiles & WMS',
