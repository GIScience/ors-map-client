...
describe('Box', () => {
  ...
  it('should render , resize, and close default box', async () => {
    ...
    expect(wrapper.find(`#${wrapper.vm.guid}`).attributes().style).toMatch(/^background: white.*; z-index: auto; border-top: 5px solid rgb\(198, 40, 40\);$/)
  ...
  it('should render section box', async () => {
  ...
  it('should render non-closable box', async () => {
  ...
  it('should render non-resizable box', async () => {
