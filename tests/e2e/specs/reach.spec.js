...
module.exports = {
  'reach landing rendering': function (browser) {
    const reachUrl = `${browser.baseUrl}/#/reach`
  ...
  'isochrones rendering': function (browser) {
    const isochronesUrl = `${browser.baseUrl}/#/reach/Rua Jataúba,Salvador,BA,Brazil/data/{"coordinates":"-38.48030090332032,-12.983147716796566","options":{"profile":"cycling-regular","range_type":"distance","range":[31000],"interval":15000,"zoom":18}}`
    ...
    browser
      ...
      .assert.textContains('.leaflet-popup-content', 'Rua Jataúba, Salvador,BA,Brazil')
