...
describe('Share', () => {
  it('should open and close share modal', async () => {
    ...
    expect(wrapper.find('.share-container').exists()).toBe(true)
  ...
  it('should open and copy share url', async () => {
    let directionsUrl = `${constants.orsPublicHost}/#/directions/Mannheim,BW,Germany/Heidelberg,BW,Germany/data/%7B"coordinates":"8.492765,49.488789;8.692416,49.401247","options":%7B"zoom":8,"profile":"driving-car","preference":"recommended"%7D%7D`
    var shareProps = {
      url: directionsUrl
    }
  ...
  it('should render share component and toggle short url', async () => {
    let directionsUrl = `${constants.orsPublicHost}/#/directions/Mannheim,BW,Germany/Heidelberg,BW,Germany/data/%7B"coordinates":"8.492765,49.488789;8.692416,49.401247","options":%7B"zoom":8,"profile":"driving-car","preference":"recommended"%7D%7D`
    var shareProps = {
      url: directionsUrl
    }
