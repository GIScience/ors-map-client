...
describe('Form-fields', () => {
  ...
  it('should render form-fields in roundtrip', async (done) => {
    ...
    let random = wrapper.find('.random-input')
    console.log(random)

    let radomInput = random.find('.v-input__append-inner')
    console.log(radomInput)

    let randomIcon = radomInput.find('.v-icon')
    console.log(randomIcon)
    await randomIcon.trigger('click')
