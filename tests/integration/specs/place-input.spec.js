...
describe('Place-input', () => {
  ...
  it('should render place-input component with `startingPlace`', async () => {
  ...
  it('should show suggestions when a place name is inputted', async () => {
    placeInputProps.isLast = false
    await new AppLoader().fetchApiInitialData()
    const wrapper = mount(PlaceInput, {propsData: placeInputProps, i18n: i18n, store: store })

    expect(wrapper.find('.place-input').exists()).toBe(true)
  ...
  it('should show suggestions when coordinates are inputted', async () => {
    placeInputProps.isLast = false
    await new AppLoader().fetchApiInitialData()
    const wrapper = mount(PlaceInput, {propsData: placeInputProps, i18n: i18n, store: store })
  ...
  it('should not show suggestions when no text is inputted', async () => {
    placeInputProps.isLast = false
    await new AppLoader().fetchApiInitialData()
    const wrapper = mount(PlaceInput, {propsData: placeInputProps, i18n: i18n, store: store })
  ...
  it('should switch to search mode on search action', async () => {
    placeInputProps.isLast = false
